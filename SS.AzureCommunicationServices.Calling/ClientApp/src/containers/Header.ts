...
import { stopSpeechRecognitionDispatch } from '../core/speechEffects';
...
const mapStateToProps = (state: State, props: HeaderProps) => ({
  ...
  endCall: (): void => {
    state.calls.call && endCall(state, state.calls.call, { forEveryone: false });
...
const mapDispatchToProps = (dispatch: any) => ({
  ...
  stopSpeechRecognitionDispatch: (): void => dispatch(stopSpeechRecognitionDispatch()),
