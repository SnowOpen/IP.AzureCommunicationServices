...
import { initSpeechRecognizerClient, startSpeechRecognitionDispatch } from '../core/speechEffects';
...
const mapDispatchToProps = (dispatch: any) => ({
  ...
  setupSpeechRecognizerClient: (groupId: string): void => dispatch(initSpeechRecognizerClient(groupId)),
  startSpeechRecognitionDispatch: (mic: boolean): void => dispatch(startSpeechRecognitionDispatch(mic)),
