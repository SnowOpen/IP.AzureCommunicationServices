...
export interface ConfigurationScreenProps {
  ...
  setupSpeechRecognizerClient(groupId: string): void;
  startSpeechRecognitionDispatch(mic: boolean): void;
  setupCallAgent(
    displayName: string,
    groupId: string,
              ...
              <PrimaryButton
                ...
                onClick={async (): Promise<void> => {
                  if (!name) {
                    ...
                    //3.5. init SpeechRecognizer
                    await props.setupSpeechRecognizerClient(groupId);

                    //4. Join the call
                    await props.joinGroup(callAgent, groupId);
                    
                    //4.5. start Speech Recognition 
                    await props.startSpeechRecognitionDispatch(props.mic);                                        
