...
import { startSpeechRecognition, stopSpeechRecognition } from './speechEffects';
...
export const endCall = async (state: State, call: Call, options: HangUpOptions): Promise<void> => {
