...
namespace Calling
{
    public class UserTokenController : Controller
    {
        ...
        private readonly string speechServiceSubscriptionKey;
        private readonly string speechServiceRegion;
        public UserTokenController(IConfiguration configuration)
        {
            ...
            speechServiceSubscriptionKey = configuration["SpeechServiceSubscriptionKey"];
            speechServiceRegion = configuration["SpeechServiceRegion"];
        }
        ...
        /// <summary>
        /// Gets a Speech Service Key to be used to initalize the Speech Recognizer
        /// </summary>
        /// <returns></returns>
        [Route("/speechServiceKey")]
        [HttpGet]
        public async Task<IActionResult> GetSpeechServiceKeyAsync()
        {
            try
            {
                var clientResponse = new
                {
                    ...
                    serviceRegion = speechServiceRegion
                };
